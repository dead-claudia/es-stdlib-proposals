...
1. When appending larger arrays and sequences (more than a 500K on FF's REPL, ~120K in Node's REPL), you can't do `array.push(...entries)` without running into a stack limit.
